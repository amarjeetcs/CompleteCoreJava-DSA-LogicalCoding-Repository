...
public class ArrayListPractical {
	public static void main(String[] args) { // add(),size(),get(),set(),remove(),contains(),addAll(),isEmpty(),indexOf(),
		...
		System.out.println("index of" + al.indexOf(10.5));
		System.out.println("size" + al.size());
		System.out.println("get" + al.get(1));
		System.out.println("set" + al.set(3, "ankit"));
		System.out.println(al);
		System.out.println(al.remove(3));
		System.out.println("after remove:" + al);
		System.out.println("contains:" + al.contains(2));
		...
		// ArrayList is child class of list interface which is used to stor the data in
		// ordered mananer and duplicates
