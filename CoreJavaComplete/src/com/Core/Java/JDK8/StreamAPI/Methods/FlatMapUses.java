...
public class FlatMapUses {
	public static void main(String[] args) {
		/*
		 * List<Integer> l=Arrays.asList(1,2,3,4,5,6); List<Integer>
		 * l1=l.stream().map(e->e+10).collect(Collectors.toList());
		...
		List<List<Integer>> fm = Arrays.asList(list1, list2, list3);
